...
public class Constants {
	...
	public static String CT_BASE_NAME = "ct-tpgei-ctlv-bA13-ct";  // exemple: ct-tpgei-ctlv-A23-ct � concat�ner avec le num�ro du CT
	public static long CT_BASE_ID = 11300;	 // � modifier (cf. sujet de tp)
